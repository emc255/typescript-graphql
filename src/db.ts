export let games = [
  ...
  },
  {
    id: 20,
    title: "Fortnite",
    platform: ["PlayStation 4", "Xbox One", "PC", "iOS", "Android"],
  },
];
...
export let reviews = [
  ...
  },
  {
    id: 2,
    rating: 7,
    content: "Enjoyable experience overall.",
    authorId: 2,
    gameId: 2,
  },
  {
    id: 3,
    rating: 9,
    content: "Fantastic gameplay and story!",
    authorId: 3,
    gameId: 3,
  },
  {
  ...
  },
  {
    id: 5,
    rating: 10,
    content: "Absolutely amazing, exceeded my expectations!",
    authorId: 5,
    gameId: 5,
  },
  {
    id: 6,
    rating: 5,
    content: "Mediocre at best, didn't live up to the hype.",
    authorId: 6,
    gameId: 6,
  },
  {
    id: 7,
    rating: 8,
    content: "Solid performance and engaging gameplay.",
    authorId: 7,
    gameId: 7,
  },
  {
    id: 8,
    rating: 3,
    content: "Disappointing, not worth the price.",
    authorId: 2,
    gameId: 8,
  },
  {
    id: 9,
    rating: 9,
    content: "Incredible graphics and immersive world.",
    authorId: 2,
    gameId: 9,
  },
  {
    id: 10,
    rating: 7,
    content: "Fun multiplayer experience.",
    authorId: 10,
    gameId: 10,
  },
  {
  ...
  },
  {
    id: 12,
    rating: 8,
    content: "Captivating storyline and memorable characters.",
    authorId: 12,
    gameId: 12,
  },
  {
    id: 13,
    rating: 4,
    content: "Buggy and unpolished, needs more updates.",
    authorId: 13,
    gameId: 13,
  },
  {
    id: 14,
    rating: 9,
    content: "Addictive gameplay and tons of replay value.",
    authorId: 14,
    gameId: 14,
  },
  {
    id: 15,
    rating: 7,
    content: "Enjoyed it, but some mechanics could be improved.",
    authorId: 15,
    gameId: 15,
  },
  {
    id: 16,
    rating: 10,
    content: "Best game I've played in years, a masterpiece!",
    authorId: 16,
    gameId: 16,
  },
  {
    id: 17,
    rating: 6,
    content: "Not bad, but not exceptional either.",
    authorId: 17,
    gameId: 17,
  },
  {
    id: 18,
    rating: 8,
    content: "Well-designed levels and challenging puzzles.",
    authorId: 18,
    gameId: 18,
  },
  {
    id: 19,
    rating: 5,
    content: "Uninspired and repetitive, got bored quickly.",
    authorId: 19,
    gameId: 2,
  },
  {
    id: 20,
    rating: 9,
    content: "Highly addictive, couldn't put it down!",
    authorId: 20,
    gameId: 2,
  },
];
